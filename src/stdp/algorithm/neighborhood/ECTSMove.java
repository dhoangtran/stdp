 ...
 * @author Hoang Tran
 */
public class ECTSMove extends Move {
     ...
     */
    public ECTSMove(Problem problem, Random random, int priority) {
    ...
    public double doMove(Solution solution, LinkedList<Integer> tabuList, HashSet<Integer> tabuSet) {
